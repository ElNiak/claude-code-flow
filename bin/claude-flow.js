...
/**
 * Claude-Flow v2.0.0-alpha.81 - Node.js Entry Point
 *
 ...
 * Build time: 2025-08-05T09:35:45.324Z
 */
...
for (const arg of args) {
  if (arg === '--version' || arg === '-v') {
    try {
      ...
      console.log('v2.0.0-alpha.81'); // Fallback
      process.exit(0);
    }
  }
}
...
async function showErrorHelp() {
  const version = await getVersion().catch(() => '2.0.0-alpha.81');
