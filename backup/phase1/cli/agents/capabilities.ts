...
export class AgentCapabilitySystem {
	...
	getTaskRequirements(task: TaskDefinition): TaskRequirements {
		...
		return {
			...
			estimatedDuration:
				...
				baseRequirements.estimatedDuration,
		};
	}
	...
	private initializeCapabilityRegistry(): CapabilityRegistry {
		return {
			codeGeneration: {
				description:
					"Ability to generate code in various programming languages",
				category: "technical",
				prerequisites: [],
			...
			codeReview: {
				description:
					"Ability to review and analyze code for quality and security",
				category: "technical",
