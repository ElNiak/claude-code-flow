...
function getOptimizedExampleTask(slug) {
	const examples = {
		architect:
			"design microservices architecture with parallel component analysis",
		...
		"security-review":
			"audit API security with parallel vulnerability assessment",
		"docs-writer":
			"create API documentation with concurrent content generation",
		...
		"refinement-optimization-mode":
			"optimize database queries with concurrent profiling",
		...
		"spec-pseudocode":
			"define payment flow requirements with concurrent validation",
		...
		tutorial:
			"guide me through SPARC methodology with interactive parallel examples",
	};
