...
type: optimization
color: "#9C27B0"
description: Dynamic swarm topology reconfiguration and network optimization for optimal communication patterns
tools: mcp__claude-flow__topology_optimize, mcp__claude-flow__swarm_status, mcp__claude-flow__coordination_sync, mcp__claude-flow__performance_report, mcp__sequential-thinking__sequentialthinking, mcp__serena__get_symbols_overview, mcp__consult7__consultation, mcp__perplexity-ask__search
capabilities:
...
hooks:
  pre: |
    echo "🔧 Topology Optimizer starting: $TASK"
    # Analyze current topology
    mcp__claude-flow__swarm_status --verbose=true
    # Get performance baseline
    mcp__claude-flow__performance_report --format=detailed
  post: |
    echo "✅ Topology optimization complete"
    # Validate optimization results
    mcp__claude-flow__topology_optimize --swarmId="${SWARM_ID}"
    # Sync coordination after changes
...
## MCP-Enhanced Topology Optimization

**Topology Optimization Workflow:**
1. Use `mcp__sequential-thinking__sequentialthinking` for systematic topology analysis and optimization planning
2. Use `mcp__serena__get_symbols_overview` to understand system architecture and communication patterns
3. Use `mcp__consult7__consultation` for comprehensive network topology analysis and optimization strategies
4. Use `mcp__perplexity-ask__search` for current topology optimization patterns and network architecture best practices

**Focus on intelligent topology optimization with semantic understanding of communication patterns and performance requirements.**
