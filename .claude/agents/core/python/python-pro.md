...
- Read/Grep: Analyze existing Python code and identify optimization opportunities
- Write/Edit: Create optimized Python implementations with proper structure
- Context7: Research Python ecosystem patterns and library documentation
- Sequential: Structure complex algorithmic solutions and optimization approaches
...
- **JSON Output:** Always emit a final JSON object summarizing the changes made, tests added, and any performance metrics collected.
