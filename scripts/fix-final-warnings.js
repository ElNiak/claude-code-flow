...
const SPECIFIC_FIXES = [
  ...
  },
  {
    ...
    fixes: [
      ...
      { pattern: /const\s+spec\s*=\s*task\.context\?\.spec;/g, replacement: 'const _spec = task.context?.spec;' },
      { pattern: /const\s+requirements\s*=\s*task\.context\?\.requirements;/g, replacement: 'const _requirements = task.context?.requirements;' },
      { pattern: /const\s+metrics\s*=\s*task\.context\?\.metrics;/g, replacement: 'const _metrics = task.context?.metrics;' },
