...
console.log("--------------------------------------");
console.log(
	"Command: claude-flow init --batch-init demo-api,demo-web,demo-cli",
);
...
console.log("----------------------------------------------");
console.log(
	"Command: claude-flow init --batch-init api-v1,api-v2 --template web-api --sparc",
);
...
console.log("-----------------------------------------------");
console.log(
	"Command: claude-flow init --batch-init myapp --environments dev,staging,prod",
);
...
console.log("---------------------------------");
console.log(
	"claude-flow batch create-config --interactive  # Create interactive config",
);
console.log(
	"claude-flow batch validate-config my-batch.json # Validate configuration",
);
console.log(
	"claude-flow batch estimate my-batch.json        # Estimate time/resources",
);
console.log(
	"claude-flow batch list-templates                # List all templates",
);
console.log(
	"claude-flow batch list-environments             # List all environments",
);
console.log();
...
console.log(
	"• Error Recovery: Continues processing even if some projects fail",
);
