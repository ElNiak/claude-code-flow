...
export class UnifiedIntelligenceSystem {
  ...
  async applyStructuredThinking(
    ...
    return this.structuredThinking.applyStructuredThinking(task, agent, context);
  }
  ...
  async applyParallelCoordination(
    ...
    return this.parallelCoordination.applyParallelCoordination(task, agents, config);
  }
  ...
  async applyStrategicOversight(
    ...
    return this.strategicOversight.applyStrategicOversight(swarmObjective, agents, config);
  }
...
export const INTELLIGENCE_CAPABILITIES = {
  [INTELLIGENCE_ENGINES.SPARC]: {
    ...
    description: 'Systematic problem-solving through Specification, Pseudocode, Architecture, Refinement, and Completion phases',
    strengths: ['Quality', 'Thoroughness', 'Systematic approach', 'Complex problem decomposition'],
    applicability: ['Complex tasks', 'Quality-critical work', 'Research and analysis', 'System design'],
    patterns: ['analytical_decomposition', 'creative_exploration', 'systematic_implementation', 'iterative_refinement']
  },
  [INTELLIGENCE_ENGINES.SWARM]: {
    name: 'Parallel Coordination (SWARM)',
    description: 'Distributed coordination for parallel task execution with fault tolerance and load balancing',
    strengths: ['Scalability', 'Parallel execution', 'Resource optimization', 'Fault tolerance'],
    applicability: ['Parallelizable tasks', 'High throughput needs', 'Resource optimization', 'Distributed work'],
    strategies: ['mesh_coordination', 'hierarchical_coordination', 'pipeline_coordination', 'star_coordination']
  },
  [INTELLIGENCE_ENGINES.HIVE]: {
    name: 'Strategic Oversight (HIVE)',
    description: 'Collective intelligence with strategic oversight, consensus building, and stakeholder management',
    strengths: ['Strategic alignment', 'Consensus building', 'Risk management', 'Stakeholder focus'],
    applicability: ['High-stakes projects', 'Multi-stakeholder environments', 'Strategic decisions', 'Long-term objectives'],
    features: ['consensus_decisions', 'strategic_objectives', 'collective_intelligence', 'risk_assessment']
  },
  [INTELLIGENCE_ENGINES.SYNTHESIS]: {
    name: 'Intelligence Synthesis',
    description: 'Unified synthesis combining all intelligence types for optimal outcomes',
    strengths: ['Holistic approach', 'Best of all engines', 'Adaptive optimization', 'Comprehensive analysis'],
    applicability: ['Complex multi-faceted tasks', 'Uncertain requirements', 'Optimization needs', 'Quality-critical deliverables'],
...
export const INTELLIGENCE_SELECTION = {
   ...
   */
  selectOptimalApproach(task: TaskDefinition, agents: AgentState[], config: Partial<SwarmConfig> = {}): string {
