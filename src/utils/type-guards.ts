 ...
 */
export function hasAgentLoad(
	value: unknown
): value is { agentId: { id: string }; load: number } {
	return (
		isObject(value) &&
		"agentId" in value &&
		isObject(value.agentId) &&
 ...
 */
export function hasAgentTask(
	value: unknown
): value is { agentId: { id: string }; task: unknown } {
	return (
		isObject(value) &&
		"agentId" in value &&
		isObject(value.agentId) &&
