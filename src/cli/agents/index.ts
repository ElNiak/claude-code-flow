...
export { createResearcherAgent, ResearcherAgent } from "./researcher.js";
export { createTesterAgent, TesterAgent } from "./tester.js";
...
export class AgentFactory {
	...
	getAgentTypeDescriptions(): Record<AgentType, string> {
		return {
			researcher:
				"Specialized in information gathering, web research, and data collection",
			coder:
				"Expert in software development, code generation, and implementation",
			analyst:
				"Focused on data analysis, performance optimization, and insights",
			architect:
				"Designs system architecture, technical specifications, and solutions",
			tester: "Specializes in testing, quality assurance, and validation",
			coordinator:
				"Manages task orchestration, planning, and team coordination",
			...
			specialist:
				"Provides domain-specific expertise and specialized knowledge",
		};
	}
