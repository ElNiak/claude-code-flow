...
// Environment detection for progress
export interface ProgressEnvironmentInfo {
	isCI: boolean;
	isTTY: boolean;
	isDocker: boolean;
	isWSL: boolean;
...
export type DetectEnvironment = () => ProgressEnvironmentInfo;
export type GetOptimalConfig = (
	env?: ProgressEnvironmentInfo,
) => ProgressConfig;
