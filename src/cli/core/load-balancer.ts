import {
	...
	hasAgentTask,
	hasWorkStealingData,
} from "../cli/shared/utils/type-guards.js";
/**
...
export class LoadBalancer extends EventEmitter {
	...
	async selectAgent(
		...
		try {
			...
			const candidates = this.filterAgentsByConstraints(
				availableAgents,
				task,
				constraints,
			);
...
function isAgentPerformanceUpdate(
	data: unknown,
): data is AgentPerformanceUpdate {
	return (
		typeof data === "object" &&
		data !== null &&
		"agentId" in data &&
