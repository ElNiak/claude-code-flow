...
// Command execution context (merged with core.ts)
...
// Additional interfaces from core.ts
...
export type CommandHandler<T = any> = (
	...
	metadata: any, // avoiding circular dependency with metadata
) => Promise<T>;
