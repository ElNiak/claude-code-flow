...
import {
	...
	CloudResource as _CloudResource,
	CloudManager,
} from "../../enterprise/cloud-manager.js";
import {
	DeploymentEnvironment as _DeploymentEnvironment,
	type Deployment,
	DeploymentManager,
...
import {
	Project as _Project,
	ProjectManager,
} from "../../enterprise/project-manager.js";
import {
		...
		options: [
			{
				...
				short: "t",
				description:
					"Scan type (vulnerability, dependency, secrets, compliance)",
				type: "string",
			},
			{
				name: "severity",
						...
						const scan = await manager.createSecurityScan({
							...
							configuration: {
								...
								formats: ctx.flags.format
									? (ctx.flags.format as string).split(",")
									: undefined,
							},
						});
