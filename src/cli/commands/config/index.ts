...
export type {
	...
	CloudResource,
	CostOptimization,
} from "./cloud/cloud-manager.js";
// Enterprise cloud management features
export { CloudManager } from "./cloud/cloud-manager.js";
// Re-export all migrated config components
export { ConfigManager } from "./manager.js";
export { PresetManager } from "./presets.js";
export type {
	ComplianceCheck,
	SecurityFinding,
	SecurityIncident,
