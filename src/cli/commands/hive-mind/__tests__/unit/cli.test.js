...
describe("Hive Mind CLI Commands", () => {
	...
	describe("hive-mind command", () => {
		...
		it("should initialize with wizard mode", () => {
			...
			const result = execSync(
				'echo "' + mockInput + '" | node src/cli/simple-cli.js hive-mind',
				{
					encoding: "utf8",
				},
			);
		...
		it("should accept command line arguments", () => {
			const result = execSync(
				'node src/cli/simple-cli.js hive-mind "Refactor authentication" --agents 5 --strategy hierarchical',
				{
					encoding: "utf8",
				},
			);
		...
		it("should handle maximum agent limits", () => {
			const result = execSync(
				'node src/cli/simple-cli.js hive-mind "Test" --agents 1001',
				{
					encoding: "utf8",
				},
			);
	...
	describe("hive-mind init", () => {
		it("should initialize SQLite database", () => {
			const result = execSync(
				"node src/cli/simple-cli.js hive-mind init --db " + testDbPath,
				{
					encoding: "utf8",
				},
			);
		...
		it("should handle existing database gracefully", () => {
			...
			// Second init
			const result = execSync(
				"node src/cli/simple-cli.js hive-mind init --db " +
					testDbPath +
					" --force",
				{
					encoding: "utf8",
	...
	describe("hive-mind spawn", () => {
		...
		it("should spawn a single agent", () => {
			const result = execSync(
				'node src/cli/simple-cli.js hive-mind spawn researcher --name "DataBot" --db ' +
					testDbPath,
				{
					encoding: "utf8",
				},
		...
		it("should spawn multiple agents in batch", () => {
			const result = execSync(
				'node src/cli/simple-cli.js hive-mind spawn --batch "researcher:3,coder:2,analyst:1" --db ' +
					testDbPath,
				{
					encoding: "utf8",
				},
		...
		it("should validate agent types", () => {
			try {
				execSync(
					"node src/cli/simple-cli.js hive-mind spawn invalid-type --db " +
						testDbPath,
				);
		...
		it("should assign unique IDs to agents", () => {
			execSync(
				'node src/cli/simple-cli.js hive-mind spawn researcher --name "Bot1" --db ' +
					testDbPath,
			);
			execSync(
				'node src/cli/simple-cli.js hive-mind spawn researcher --name "Bot2" --db ' +
					testDbPath,
			);

			const result = execSync(
				"node src/cli/simple-cli.js hive-mind list --db " + testDbPath,
				{
					encoding: "utf8",
				},
			);
	...
	describe("hive-mind list", () => {
		beforeEach(() => {
			execSync("node src/cli/simple-cli.js hive-mind init --db " + testDbPath);
			execSync(
				'node src/cli/simple-cli.js hive-mind spawn researcher --name "R1" --db ' +
					testDbPath,
			);
			execSync(
				'node src/cli/simple-cli.js hive-mind spawn coder --name "C1" --db ' +
					testDbPath,
			);
		});
		...
		it("should filter by agent type", () => {
			const result = execSync(
				"node src/cli/simple-cli.js hive-mind list --type researcher --db " +
					testDbPath,
				{
					encoding: "utf8",
				},
		...
		it("should show detailed information with --verbose", () => {
			const result = execSync(
				"node src/cli/simple-cli.js hive-mind list --verbose --db " +
					testDbPath,
				{
					encoding: "utf8",
				},
	...
	describe("hive-mind task", () => {
		...
		it("should distribute task to agents", () => {
			const result = execSync(
				'node src/cli/simple-cli.js hive-mind task "Implement user authentication" --db ' +
					testDbPath,
				{
					encoding: "utf8",
				},
		...
		it("should support task priorities", () => {
			const result = execSync(
				'node src/cli/simple-cli.js hive-mind task "Critical bug fix" --priority critical --db ' +
					testDbPath,
				{
					encoding: "utf8",
				},
		...
		it("should handle task dependencies", () => {
			execSync(
				'node src/cli/simple-cli.js hive-mind task "Task A" --id task-a --db ' +
					testDbPath,
			);
			const result = execSync(
				'node src/cli/simple-cli.js hive-mind task "Task B" --depends-on task-a --db ' +
					testDbPath,
				{
					encoding: "utf8",
				},
	...
	describe("hive-mind communicate", () => {
		...
		it("should send message between agents", () => {
			const result = execSync(
				'node src/cli/simple-cli.js hive-mind communicate --from R1 --to C1 --message "Found relevant API docs" --db ' +
					testDbPath,
				{
					encoding: "utf8",
				},
		...
		it("should support broadcast messages", () => {
			const result = execSync(
				'node src/cli/simple-cli.js hive-mind communicate --from R1 --broadcast --message "Team update" --db ' +
					testDbPath,
				{
					encoding: "utf8",
				},
		...
		it("should handle message types", () => {
			const result = execSync(
				'node src/cli/simple-cli.js hive-mind communicate --from R1 --to C1 --message "Code review needed" --type request --db ' +
					testDbPath,
				{
					encoding: "utf8",
				},
	...
	describe("hive-mind consensus", () => {
		beforeEach(() => {
			execSync("node src/cli/simple-cli.js hive-mind init --db " + testDbPath);
			execSync(
				'node src/cli/simple-cli.js hive-mind spawn --batch "researcher:3,analyst:2" --db ' +
					testDbPath,
			);
		});
		...
		it("should initiate consensus voting", () => {
			const result = execSync(
				'node src/cli/simple-cli.js hive-mind consensus "Should we use TypeScript?" --db ' +
					testDbPath,
				{
					encoding: "utf8",
				},
		...
		it("should show voting results", () => {
			execSync(
				'node src/cli/simple-cli.js hive-mind consensus "Tech stack decision" --id vote-1 --db ' +
					testDbPath,
			);
			const result = execSync(
				"node src/cli/simple-cli.js hive-mind consensus status vote-1 --db " +
					testDbPath,
				{
					encoding: "utf8",
				},
		...
		it("should support weighted voting", () => {
			const result = execSync(
				'node src/cli/simple-cli.js hive-mind consensus "Architecture decision" --weighted --db ' +
					testDbPath,
				{
					encoding: "utf8",
				},
	...
	describe("hive-mind memory", () => {
		...
		it("should store shared memory", () => {
			const result = execSync(
				'node src/cli/simple-cli.js hive-mind memory store --key "api-docs" --value "https://api.example.com/docs" --db ' +
					testDbPath,
				{
					encoding: "utf8",
				},
		...
		it("should retrieve shared memory", () => {
			execSync(
				'node src/cli/simple-cli.js hive-mind memory store --key "config" --value "{"port":3000}" --db ' +
					testDbPath,
			);
			const result = execSync(
				'node src/cli/simple-cli.js hive-mind memory get --key "config" --db ' +
					testDbPath,
				{
					encoding: "utf8",
				},
		...
		it("should list all memory entries", () => {
			execSync(
				'node src/cli/simple-cli.js hive-mind memory store --key "k1" --value "v1" --db ' +
					testDbPath,
			);
			execSync(
				'node src/cli/simple-cli.js hive-mind memory store --key "k2" --value "v2" --db ' +
					testDbPath,
			);
			const result = execSync(
				"node src/cli/simple-cli.js hive-mind memory list --db " + testDbPath,
				{
					encoding: "utf8",
				},
			);
	...
	describe("hive-mind status", () => {
		beforeEach(() => {
			execSync("node src/cli/simple-cli.js hive-mind init --db " + testDbPath);
			execSync(
				'node src/cli/simple-cli.js hive-mind spawn --batch "researcher:2,coder:3" --db ' +
					testDbPath,
			);
		});
		...
		it("should show swarm status", () => {
			const result = execSync(
				"node src/cli/simple-cli.js hive-mind status --db " + testDbPath,
				{
					encoding: "utf8",
				},
			);
		...
		it("should show performance metrics", () => {
			const result = execSync(
				"node src/cli/simple-cli.js hive-mind status --metrics --db " +
					testDbPath,
				{
					encoding: "utf8",
				},
	...
	describe("hive-mind scale", () => {
		beforeEach(() => {
			execSync("node src/cli/simple-cli.js hive-mind init --db " + testDbPath);
			execSync(
				'node src/cli/simple-cli.js hive-mind spawn --batch "researcher:2" --db ' +
					testDbPath,
			);
		});
		...
		it("should scale up agents", () => {
			const result = execSync(
				"node src/cli/simple-cli.js hive-mind scale up --agents 3 --type researcher --db " +
					testDbPath,
				{
					encoding: "utf8",
				},
		...
		it("should scale down agents", () => {
			const result = execSync(
				"node src/cli/simple-cli.js hive-mind scale down --agents 1 --db " +
					testDbPath,
				{
					encoding: "utf8",
				},
		...
		it("should auto-scale based on load", () => {
			const result = execSync(
				"node src/cli/simple-cli.js hive-mind scale auto --min 2 --max 10 --db " +
					testDbPath,
				{
					encoding: "utf8",
				},
	...
	describe("hive-mind export/import", () => {
		...
		it("should export swarm configuration", () => {
			const result = execSync(
				"node src/cli/simple-cli.js hive-mind export --output " +
					exportPath +
					" --db " +
					testDbPath,
				{
		...
		it("should import swarm configuration", () => {
			...
			const result = execSync(
				"node src/cli/simple-cli.js hive-mind import --input " +
					exportPath +
					" --db " +
					newDbPath,
				{
