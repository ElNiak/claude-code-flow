...
export function showInitHelp() {
	console.log(
		"Initialize Claude Code integration files with Claude Flow v2.0.0",
	);
	console.log();
	...
	console.log(
		"  --dry-run, -d        Preview what would be created without making changes",
	);
	console.log("  --help, -h           Show this help message");
	console.log();
	console.log("Alternative Initialization Modes:");
	console.log(
		"  --basic              Use basic initialization (pre-v2.0.0 behavior)",
	);
	console.log(
		"  --sparc, -s          Initialize with SPARC development environment",
	);
	console.log("  --minimal, -m        Create minimal configuration files");
	console.log(
		"  --modes <list>       Initialize only specific SPARC modes (comma-separated)",
	);
	console.log(
		"  --skip-mcp           Skip automatic MCP server setup in Claude Code",
	);
	console.log();
	console.log("Advanced Options:");
	console.log(
		"  --enhanced, --safe   Enhanced initialization with validation and rollback",
	);
	...
	console.log(
		"  --list-backups       List available backups and rollback points",
	);
	console.log();
	...
	console.log(
		"  --validate --skip-pre-init           Skip pre-init validation",
	);
	console.log(
		"  --validate --skip-config            Skip configuration validation",
	);
	...
	console.log(
		"  • .claude/settings.json - Global configuration with hooks and features",
	);
	console.log(
