...
export interface CliMiddleware {
  name: string;
  priority?: number;
  beforeCommand?: (context: CommandContext, next: () => Promise<void>) => Promise<void>;
  afterCommand?: (context: CommandContext, result: CommandResult, next: () => Promise<void>) => Promise<void>;
  onError?: (error: CliError, context: CommandContext, next: (error?: Error) => Promise<void>) => Promise<void>;
}
