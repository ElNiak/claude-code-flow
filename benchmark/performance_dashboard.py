...
try:
    ...
    print(
        "Warning: Could not import performance monitor - dashboard will use sample data"
    )
...
class PerformanceDashboard:
    ...
    def _create_html_template(
        self, dashboard_data: Dict[str, Any], regression_data: Dict[str, Any]
    ) -> str:
...
def main():
    ...
    parser.add_argument(
        "--output-dir", default="dashboard_output", help="Output directory"
    )
    parser.add_argument(
        "--data-source",
        choices=["database", "sample"],
        default="database",
        help="Data source",
    )
    parser.add_argument(
        "--create-server", action="store_true", help="Create dashboard server script"
    )
    parser.add_argument(
        "--serve", action="store_true", help="Generate dashboard and start server"
    )
