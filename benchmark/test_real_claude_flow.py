...
class RealClaudeFlowBenchmark:
    ...
    def test_basic_commands(self):
        ...
        self.run_command([str(self.claude_flow_path), "--version"], "Version Check")

        # Test 2: Help command
        self.run_command([str(self.claude_flow_path), "--help"], "Help Command")
    ...
    def generate_report(self):
        ...
        if self.results:
            avg_duration = sum(r.get("duration", 0) for r in self.results) / len(
                self.results
            )
