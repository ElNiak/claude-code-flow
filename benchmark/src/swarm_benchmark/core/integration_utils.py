...
class OutputParser:
    ...
    def parse_output(cls, output: str) -> Dict[str, Any]:
        ...
        result = {
            ...
            "agents": {"started": [], "completed": []},
            "files": {"created": [], "modified": []},
            "tests": {"passed": 0, "failed": 0, "coverage": None},
            "errors": [],
            "warnings": [],
            "memory_keys": [],
            "swarm_id": None,
...
class CommandBuilder:
    ...
    VALID_MODES = {"centralized", "distributed", "hierarchical", "mesh", "hybrid"}
    ...
    @classmethod
    def build_swarm_command(cls, objective: str, **kwargs) -> List[str]:
    ...
    @classmethod
    def build_sparc_command(
        cls, prompt: str, mode: Optional[str] = None, **kwargs
    ) -> List[str]:
...
class ProgressTracker:
    ...
    def __init__(self):
        ...
        self.task_progress = defaultdict(
            lambda: {"status": "pending", "start": None, "end": None}
        )
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        completed_tasks = sum(
            1 for t in self.task_progress.values() if t["status"] == "completed"
        )
        ...
        return {
            ...
            "tasks": {
                ...
                "pending": sum(
                    1 for t in self.task_progress.values() if t["status"] == "pending"
                ),
            },
