...
class HierarchicalMode(BaseCoordinationMode):
    ...
    def _distribute_tasks_to_managers(
    ...
    async def _manager_execution(
        self, manager: Agent, tasks: List[Task]
    ) -> List[Result]:
        ...
        for task in tasks:
            ...
            if available_workers:
                ...
                result = await self._execute_hierarchical_task(
                    task, manager, self.root_coordinator
                )
    ...
    async def _execute_hierarchical_task(
        self, task: Task, executor: Agent, supervisor: Agent
    ) -> Result:
        ...
        try:
            ...
            result.performance_metrics.communication_latency = (
                0.04  # Half of coordination overhead
            )
    ...
    def get_coordination_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "root_coordinator": self.root_coordinator.id
