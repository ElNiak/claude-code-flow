...
def example_sparc_modes():
    ...
    print("\n1. TDD Mode:")
    print(
        f'   Command: claude-flow sparc run {tdd_config.mode.value} "{tdd_config.prompt}"'
    )
    ...
    print("\n2. Optimizer Mode:")
    print(
        f'   Command: claude-flow sparc run {optimizer_config.mode.value} "{optimizer_config.prompt}"'
    )
    ...
    print(
        f'   Command: claude-flow sparc run {workflow_config.mode.value} "{workflow_config.prompt}"'
    )
...
def example_error_handling():
    ...
    executor = ClaudeFlowExecutor(retry_attempts=3, retry_delay=2.0)
...
def example_memory_operations():
    ...
    test_data = {
        ...
        "metrics": {"performance": 95, "reliability": 98, "scalability": 92},
