...
const workflowTools = [
	{
		...
		params: { name: "Test Workflow", steps: ["step1", "step2"] },
	},
	{ name: "workflow_execute", params: { workflowId: "test-123" } },
	{
		name: "automation_setup",
		params: { rules: [{ trigger: "file_change", action: "notify" }] },
	},
	{
		name: "pipeline_create",
		params: { config: { name: "CI Pipeline", stages: ["build", "test"] } },
	},
	{
		name: "scheduler_manage",
		params: {
			action: "create",
			schedule: { task: "backup", cron: "0 0 * * *" },
		},
	},
	{ name: "trigger_setup", params: { events: ["push"], actions: ["build"] } },
	{
		name: "workflow_template",
		params: { action: "create", template: { name: "Basic" } },
	},
	{
		name: "batch_process",
		params: { items: ["item1", "item2"], operation: "process" },
	},
	{ name: "parallel_execute", params: { tasks: ["task1", "task2", "task3"] } },
	{
		name: "sparc_mode",
		params: { mode: "code", task_description: "Build feature", options: {} },
	},
	{
		name: "task_orchestrate",
		params: { task: "Complex workflow", strategy: "parallel" },
	},
];
...
console.log(
	`   ${builderComponents.length} drag-and-drop components available`,
);
