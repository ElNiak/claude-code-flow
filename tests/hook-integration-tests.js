...
export class HookIntegrationTests {
	 ...
	 */
	async testProcessPoolEfficiency() {
	 ...
	 */
	async testHookStampedePrevention() {
	 ...
	 */
	async testEmergencyTermination() {
	 ...
	 * Load test worker
	 */
	async loadTestWorker(workerId, endTime, results) {
...
export async function runHookIntegrationTests() {
...
//# sourceMappingURL=hook-integration-tests.js.map
