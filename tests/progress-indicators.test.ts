...
import { ProgressIndicator, createProgressIndicator } from '../src/ui/progress/progress-indicator.js';
import { ProgressAwareAgent } from '../src/ui/progress/progress-aware-agent.js';
import { EnhancedCoderAgent, EnhancedCoordinatorAgent } from '../src/ui/progress/agent-integrations.js';
  ...
  describe('Step Management', () => {
    ...
    it('should calculate progress correctly', () => {
      const steps = [
        ...
        { id: 'step2', name: 'Step 2', description: 'Second step', weight: 0.7 }
      ];
...
describe('Performance Characteristics', () => {
  it('should complete immediately without artificial delays', async () => {
    ...
    const progress = createProgressIndicator('test', 'Performance Test', () => {});
...
describe('Error Handling', () => {
  it('should handle invalid step IDs gracefully', () => {
    ...
    expect(() => progress.startStep('invalid')).toThrow('Step invalid not found');
    expect(() => progress.completeStep('invalid')).toThrow('Step invalid not found');
    expect(() => progress.failStep('invalid', 'error')).toThrow('Step invalid not found');
  });
