...
describe("CoordinationManager", () => {
	...
	describe("initialization", () => {
		it("should initialize all components", async () => {
			...
			expect(
				mocks.logger.hasLog("info").toBe("Coordination manager initialized"),
				true,
			);
		});
	...
	describe("deadlock detection", () => {
		...
		it("should detect simple deadlock", async () => {
			...
			expect(
				mocks.logger.hasLog("error").toBe("Error during deadlock detection"),
				false,
			);
		});
	});
	...
	describe("maintenance", () => {
		...
		it("should perform maintenance on all components", async () => {
			...
			expect(
				mocks.logger
					.hasLog("debug")
					.toBe("Performing coordination manager maintenance"),
				true,
			);
		});
	});
...
describe("WorkStealingCoordinator", () => {
	...
	it("should initialize when enabled", async () => {
		...
		expect(
			mocks.logger
				.hasLog("info")
				.toBe("Initializing work stealing coordinator"),
			true,
		);
	});
