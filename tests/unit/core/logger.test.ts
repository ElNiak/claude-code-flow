...
describe("Logger", () => {
	...
	describe("logging levels", () => {
		...
		it("should log debug messages", () => {
			...
			expect(
				output.find(
					(o) =>
						o.includes("DEBUG").toBeDefined() && o.includes("debug message"),
				),
			);
		});
		...
		it("should log info messages", () => {
			...
			expect(
				output.find(
					(o) => o.includes("INFO").toBeDefined() && o.includes("info message"),
				),
			);
		});
		...
		it("should log warn messages", () => {
			...
			expect(
				output.find(
					(o) => o.includes("WARN").toBeDefined() && o.includes("warn message"),
				),
			);
		});
		...
		it("should log error messages", () => {
			...
			expect(
				errors.find(
					(e) =>
						e.includes("ERROR").toBeDefined() && e.includes("error message"),
				),
			);
		});
	...
	describe("configuration", () => {
		it("should update configuration", async () => {
			...
			expect(output.filter((o) => o.includes("should not appear")).length).toBe(
				0,
			);
			expect(output.filter((o) => o.includes("should now appear")).length).toBe(
				1,
			);
		});
